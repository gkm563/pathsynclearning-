...
export default function StageTransitionOverlay({ isOpen, currentStageTitle, nextStageTitle, roleColor = "#6c63ff", onComplete }: { isOpen: boolean; currentStageTitle: string; nextStageTitle: string; roleColor?: string; onComplete?: () => void }) {
