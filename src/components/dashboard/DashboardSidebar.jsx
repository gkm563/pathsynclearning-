          ...
          >
            <div>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 17, fontWeight: 800, color: "var(--text-main)" }}>Rahul Kushwaha</div>
                  <div style={{ fontFamily: "'Fira Code', monospace", fontSize: 11, color: "#6c63ff", fontWeight: 700, letterSpacing: 0.5, marginTop: 2 }}>B.TECH · IIT KANPUR</div>
                </div>
              </div>
