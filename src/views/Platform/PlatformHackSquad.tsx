...
export default function PlatformHackSquad() {
  ...
  const [selectedPublicSquad, setSelectedPublicSquad] = useState<any>(null);

  // Free Plan Join Application
  const [showApplyModal, setShowApplyModal] = useState(false);
  const [applySquad, setApplySquad] = useState<any>(null);
  ...
  const [memberIdsList, setMemberIdsList] = useState<any[]>([]);

  // Delete squad confirm states
  const [squadToDelete, setSquadToDelete] = useState<any>(null);
  ...
  const [speakingStates, setSpeakingStates] = useState<Record<string, any>>({});
                        ...
                        <div style={{
                          ...
                          <form 
                            onSubmit={(e) => {
                              ...
                              const title = String(fd.get("taskTitle") || "");
                              const assignee = String(fd.get("taskAssignee") || "");
                              if (!title.trim()) return;
