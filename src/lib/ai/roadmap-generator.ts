...
function buildFallbackRoadmap(profile: RoadmapProfile) {
  ...
  const phases = [
    {
      id: "phase-1",
      title: "Foundations & Core CS Concepts",
      description: "Master essential programming fundamentals, data structures, algorithms, and git version control.",
      topics: [
        { title: "Data Structures & Algorithms", desc: "Arrays, LinkedLists, Strees, Graphs, and Big-O notation complexity analysis.", hours: 25 },
    ...
    {
      id: "phase-2",
      title: "Core Domain Mastery & Advanced Engineering",
      description: "Deep dive into production frameworks, state management, database design, and asynchronous patterns.",
      topics: [
        { title: "Frontend Architecture & Modern React/Next.js", desc: "Component design patterns, Server Components, Hooks, and client state management.", hours: 30 },
    ...
    {
      id: "phase-3",
      title: "Real-World Capstone & Technical Readiness",
