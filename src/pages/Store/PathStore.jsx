      ...
      <main style={{ maxWidth: 1200, margin: "40px auto", padding: "0 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 24 }}>
          {storeItems.map((item, idx) => (
            <div key={idx} style={{ background: "var(--bg-card)", border: "1.5px solid var(--border-light)", borderRadius: 20, padding: 24, display: "flex", flexDirection: "column", justify: "space-between", boxShadow: "0 10px 30px rgba(0,0,0,0.05)" }}>
              <div>
