...
export default function OnboardingStage3() {
  ...
  // User data (synced from stage 1 & stage 2 via localStorage if available)
  const stored1 = (() => {
    try { return JSON.parse(localStorage.getItem("pathEdStage1") || "{}"); }
    catch { return {}; }
  })();

  const stored2 = (() => {
    try { return JSON.parse(localStorage.getItem("pathEdStage2") || "{}"); }
    catch { return {}; }
  })();
