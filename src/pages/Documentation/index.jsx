        ...
        <aside style={{ width: 280, borderRight: "1px solid #eaecff", padding: "40px 32px", display: "flex", flexDirection: "column", gap: 24, position: "sticky", top: 100, height: "calc(100vh - 100px)", overflowY: "auto" }}>
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <li><a href="#quick-start" style={{ color: "#666", textDecoration: "none" }}>Quick Start</a></li>
              <li><a href="#core-concepts" style={{ color: "#666", textDecoration: "none" }}>Core Concepts</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              <li><a href="#skill-trees" style={{ color: "#666", textDecoration: "none" }}>Skill Trees</a></li>
              <li><a href="#cri-algorithm" style={{ color: "#666", textDecoration: "none" }}>CRI Algorithm</a></li>
              <li><a href="#ai-mentorship" style={{ color: "#666", textDecoration: "none" }}>AI Mentorship</a></li>
            </ul>
          </div>
        </aside>
        ...
        <main style={{ flex: 1, padding: "60px 80px", maxWidth: 900, scrollBehavior: "smooth" }}>
          <motion.div {...fadeInUp}>
            ...
            <section id="introduction" style={{ paddingTop: 24, marginBottom: 64 }}>
              <h1 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 48, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>
            ...
            <section id="quick-start" style={{ paddingTop: 80, marginTop: -80, marginBottom: 64 }}>
              <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 36, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>Quick Start</h2>
              <p style={{ fontSize: 18, color: "#666", lineHeight: 1.8, marginBottom: 24 }}>
            ...
            <section id="core-concepts" style={{ paddingTop: 80, marginTop: -80, marginBottom: 64 }}>
              <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 36, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>Core Concepts</h2>
              <p style={{ fontSize: 18, color: "#666", lineHeight: 1.8, marginBottom: 24 }}>
              ...
              <ul style={{ listStyleType: "none", padding: 0, display: "flex", flexDirection: "column", gap: 24 }}>
                <li style={{ padding: 24, border: "1px solid #eaecff", borderRadius: 16, background: "#fff" }}>
                  <h4 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, fontWeight: 700, color: "#6c63ff", marginBottom: 8 }}>Proof of Work</h4>
                  <p style={{ color: "#666", lineHeight: 1.6, margin: 0 }}>We do not do multiple-choice quizzes. Everything is project-based. You write code, our automated CI/CD pipeline tests it against hidden test cases.</p>
                </li>
                <li style={{ padding: 24, border: "1px solid #eaecff", borderRadius: 16, background: "#fff" }}>
                  <h4 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, fontWeight: 700, color: "#00c9a7", marginBottom: 8 }}>Skill Decay</h4>
                  <p style={{ color: "#666", lineHeight: 1.6, margin: 0 }}>Technology moves fast. If you don't use a skill, your rating in that specific node will slowly decay over time, mimicking real-world knowledge retention.</p>
                </li>
                <li style={{ padding: 24, border: "1px solid #eaecff", borderRadius: 16, background: "#fff" }}>
                  <h4 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, fontWeight: 700, color: "#f7971e", marginBottom: 8 }}>Recruiter Transparency</h4>
                  <p style={{ color: "#666", lineHeight: 1.6, margin: 0 }}>Recruiters on our platform can see your exact code submissions (with your permission), allowing them to evaluate your actual coding style.</p>
                </li>
              </ul>
            </section>
            ...
            <section id="skill-trees" style={{ paddingTop: 80, marginTop: -80, marginBottom: 64 }}>
              <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 36, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>Skill Trees</h2>
              <p style={{ fontSize: 18, color: "#666", lineHeight: 1.8, marginBottom: 24 }}>
            ...
            <section id="cri-algorithm" style={{ paddingTop: 80, marginTop: -80, marginBottom: 64 }}>
              <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 36, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>The CRI Algorithm</h2>
              <p style={{ fontSize: 18, color: "#666", lineHeight: 1.8, marginBottom: 24 }}>
            ...
            <section id="ai-mentorship" style={{ paddingTop: 80, marginTop: -80, marginBottom: 64 }}>
              <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 36, fontWeight: 800, color: "#1a1a2e", marginBottom: 24 }}>AI Mentorship</h2>
              <p style={{ fontSize: 18, color: "#666", lineHeight: 1.8, marginBottom: 24 }}>
