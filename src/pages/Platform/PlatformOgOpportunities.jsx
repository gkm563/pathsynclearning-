...
export default function PlatformOgOpportunities() {
  ...
  // Local storage for applied opportunity IDs on this page
  const [appliedOgIds, setAppliedOgIds] = useState(() => {
    const saved = localStorage.getItem("pathed_applied_og_opportunities");
    return saved ? JSON.parse(saved) : [];
  });

  // Local storage for applied events from Events Page
