...
export default function Platform() {
  ...
  return (
    <div style={{ background: "var(--bg-main)", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section id="features" style={{ padding: "100px 32px", background: "var(--bg-card)", borderTop: "1px solid #f0f2ff", borderBottom: "1px solid #f0f2ff" }}>
        <div style={{ maxWidth: 1360, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <motion.div {...fadeInUp} style={{ flex: "1 1 600px", position: "relative" }}>
            <div style={{ background: "linear-gradient(135deg, #f0f0ff, #e8faf5)", padding: 40, borderRadius: 24, border: "2px solid #d8d4ff" }}>
              <div style={{ background: "var(--bg-card)", padding: 30, borderRadius: 16, boxShadow: "0 10px 30px rgba(0,0,0,0.05)" }}>
                ...
                <SkillBar label="System Design" pct={0} c="var(--border-light)" delay={0} />
              </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* Challenges Section */}
      <section id="challenges" style={{ padding: "100px 32px", background: "var(--bg-main)" }}>
        <div style={{ maxWidth: 1360, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap", flexDirection: "row-reverse" }}>
          ...
          <motion.div {...fadeInUp} style={{ flex: "1 1 600px" }}>
             <HoverCard style={{ height: 400, borderRadius: 24, overflow: "hidden", boxShadow: "0 20px 60px rgba(108,99,255,0.15)", border: "1px solid var(--border-light)" }}>
      ...
      <section style={{ padding: "120px 32px", background: "var(--bg-main)" }}>
        <div style={{ maxWidth: 1360, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap-reverse" }}>
          ...
          <motion.div {...fadeInUp} style={{ flex: "1 1 600px" }}>
            <HoverCard style={{ width: "100%", height: 450, borderRadius: 24, overflow: "hidden", position: "relative", boxShadow: "0 20px 60px rgba(0,0,0,0.1)", border: "1.5px solid var(--border-light)" }}>
          ...
          <motion.div {...fadeInUp} style={{ flex: "1 1 500px" }}>
            ...
            <p style={{ fontSize: 18, color: "var(--text-muted)", lineHeight: 1.8, marginBottom: 30 }}>
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto", textAlign: "center" }}>
          ...
          <motion.div {...fadeInUp} style={{ display: "flex", gap: 24, justifyContent: "center", flexWrap: "wrap" }}>
            {["React JS", "System Design", "SQL Joins"].map((skill, i) => (
              <InteractiveCard key={skill} delay={i * 0.1} style={{ background: "var(--bg-card)", padding: "30px 40px", borderRadius: 16, border: `2px solid ${i === 1 ? "#ffe0a0" : "var(--border-light)"}`, boxShadow: "0 10px 30px rgba(0,0,0,0.05)" }}>
                <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 24, fontWeight: 700, color: "var(--text-main)", marginBottom: 12 }}>{skill}</div>
