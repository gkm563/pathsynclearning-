...
export default function PlatformMentorship() {
  ...
  const [selectedMentor, setSelectedMentor] = useState(null); // Detailed testimonial/bio popup modal
  const [bookingMentor, setBookingMentor] = useState(null); // Slot confirmation popup
  ...
  const handleTabChange = (tabId) => {
    ...
    if (tabId === "progress") navigate("/progress");
                              ...
                              <div style={{ marginTop: 20, padding: 20, background: "var(--bg-alt)", border: "1.5px solid var(--border-light)", borderRadius: 18 }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                                  {[
                                    ...
                                    <div 
                                      key={sIdx}
                                      onClick={() => navigate(`/live-class?teacher=${m.id}&topic=${encodeURIComponent(session.topic)}`)}
                                      style={{
