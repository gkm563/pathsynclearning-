...
import { GraduationCap, Briefcase, BookOpen, Eye, EyeOff, Github, Linkedin, AlertCircle, ArrowRight } from "lucide-react";
      ...
      <div style={{ flex: "1 1 50%", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <button style={{ flex: 1, padding: 12, background: "transparent", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer" }}>
