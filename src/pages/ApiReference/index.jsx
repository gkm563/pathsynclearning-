        ...
        <aside style={{ width: 280, borderRight: "1px solid rgba(255,255,255,0.1)", padding: "40px 32px", display: "flex", flexDirection: "column", gap: 24, position: "sticky", top: 100, height: "calc(100vh - 100px)", overflowY: "auto" }}>
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              <li><a href="#" style={{ color: "#00c9a7", fontWeight: 600, textDecoration: "none" }}>Authentication</a></li>
              <li><a href="#" style={{ color: "#d1d5db", textDecoration: "none" }}>Users</a></li>
              <li><a href="#" style={{ color: "#d1d5db", textDecoration: "none" }}>CRI Scores</a></li>
              <li><a href="#" style={{ color: "#d1d5db", textDecoration: "none" }}>Skill Trees</a></li>
            </ul>
          </div>
        </aside>

        {/* Content */}
        <main style={{ flex: 1, padding: "60px 80px", maxWidth: 1000 }}>
          <motion.div {...fadeInUp}>
            ...
            <div style={{ border: "1px solid rgba(255,255,255,0.1)", borderRadius: 16, overflow: "hidden", marginBottom: 48 }}>
